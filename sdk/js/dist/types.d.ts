 ...
 */
export declare class ESMError extends Error {
    readonly status: number;
    readonly requestId?: string | undefined;
    readonly details?: Record<string, unknown> | undefined;
    constructor(message: string, status: number, requestId?: string | undefined, details?: Record<string, unknown> | undefined);
}
/**
 * Network error for connection issues
 */
export declare class NetworkError extends ESMError {
    constructor(message: string, cause?: Error);
}
/**
 * Timeout error for requests that exceed the timeout
 */
export declare class TimeoutError extends ESMError {
    constructor(timeout: number);
}
/**
 * Retry exhausted error when all retry attempts fail
 */
export declare class RetryExhaustedError extends ESMError {
